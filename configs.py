...
x_sc = 18*lambda_0 # Location in x-axis
...
x_s= Wm-2*lambda_0 # Position of source in x-axis.
Nr = 81
h = Dm/(Nr-1)
...
xg = np.linspace(x_sc-3*lambda_0,x_sc+3*lambda_0,Nx)
yg = np.linspace(y_sc-3*lambda_0,y_sc+3*lambda_0,Ny)
