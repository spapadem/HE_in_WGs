...
%  Output:
%
%    logical TRUEFALSE, is TRUE (1) if the characters are equal.
%
...
%  Input:
%
%    string GMSH_FILENAME, the GMSH filename.
%
%    integer NODE_DIM, the spatial dimension.
%
...
%  Output:
%
%    real NODE_X(NODE_DIM,NODE_NUM), the node coordinates.
%
...
%  Input:
%
%    character S1(*), S2(*), the strings to be compared.
%
%  Output:
%
