...
WG = MoveTo(0,0).Rectangle(W,D).Face() # Creating the rectangle of size WxD.
...
savemat("data/data_incident.mat",{"u":sol_on_grid}) # Save a mat file of the solution on a regular grid.
